...
def price_oblig_fixe(date_valeur,type_titre,taux_courbe,taux_facial, Nominal,date_emission,date_jouissance,date_echeance,mat_init,mat_res, date_premier_coupon, cp, cs):
    dico = {}
    ktx, kp = 'taux', 'price'
